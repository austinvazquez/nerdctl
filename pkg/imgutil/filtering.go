...
func FilterUntil(until string) FilterFunc {
	return func(imageList []images.Image) ([]images.Image, error) {
		if len(until) == 0 {
...
func FilterByLabel(ctx context.Context, client *containerd.Client, labels map[string]string) FilterFunc {
	return func(imageList []images.Image) ([]images.Image, error) {
		return filter(imageList, func(i images.Image) (bool, error) {
			...
			return matchesAnyLabel(imageCfg.Config.Labels, labels), nil
		})
	}
}
...
func FilterDanglingImages() FilterFunc {
	return func(imageList []images.Image) ([]images.Image, error) {
		return filter(imageList, func(i images.Image) (bool, error) {
...
func FilterTaggedImages() FilterFunc {
	return func(imageList []images.Image) ([]images.Image, error) {
		return filter(imageList, func(i images.Image) (bool, error) {
			return !isDangling(i), nil
		})
...
func matchesAnyLabel(imageCfgLabels map[string]string, filterLabels map[string]string) bool {
